...
export const CasinoTop = () => {
  return (
    ...
    <Container className='Outer'>
        ...
        place_address='1313 Hiney Road, Nevada, 702-245-5532' />
        ...
        place_address='3710 Hall Street, Nevada, 702-594-0623' />
        ...
        place_address='3676 Sunrise Road, Nevada, 702-884-9835' />
        ...
        place_address='33 Hall Street, Nevada, 702-438-8461' />
        ...
        place_address='786 Hickory Ridge Drive, Nevada, 702-635-4704' />
        ...
        place_address='316 Mesa Drive, Nevada, 702-393-5825' />
        ...
        place_address='2644 Mesa Drive, Nevada, 702-407-5828' />
        ...
        place_address='2115 Hall Street, Nevada, 702-554-9073' />
        ...
        place_address='4443 Hall Street, Nevada, 702-497-9610' />
        ...
        place_address='964 Platinum Drive, Nevada, 724-769-9720724-769-9720' />
      </Container>
    <FooterNav />
    </>
  )
